                ...
                <form action="{{ route('parties.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-control" required>
                                <option value="both" {{ old('type') == 'both' ? 'selected' : '' }}>Both (Customer & Supplier)</option>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="billing_address" class="form-control" rows="3">{{ old('billing_address') }}</textarea>
